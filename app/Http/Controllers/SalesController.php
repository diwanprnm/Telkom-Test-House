...
{ 
    ...
    { 
        ...
        if ($currentUser){
            ...
            $select = array("stels_sales.id","stels_sales.created_at","stels_sales.invoice","stels_sales.payment_status","stels_sales.payment_method","stels_sales.VA_name","stels_sales.total","stels_sales.cust_price_payment","companies.name as company_name",
