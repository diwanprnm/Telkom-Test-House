...
return [
	...
	'description_rent_chamber'	=> 'Welcome to the Rent Wireless / Anechoic Chamber service of Telkom Test House Laboratory! This service provides an opportunity for customers to test their devices to ensure that they meet the specified test references. During the rent period, customers can use the opportunity to test the device to get the desired results by staying with the Telkom Test House Test Engineer. For Wireless / Anechoic Chamber rent services, please pay attention to the following points :',
