...
return [
	...
	'service_company_owner'			=> 'Owner Tools',
	...
	'rent_chamber'	=> 'Rent Wireless / Anechoic Chamber',
	'subtitle_rent_chamber'	=> 'This service provides an opportunity for customers to test their devices to ensure that they meet the specified test references.',
	'description_rent_chamber'	=> 'Welcome to the Rent Wireless / Anechoic Chamber service of Telkom Test House Laboratory! This service provides an opportunity for customers to test their devices to ensure that they meet the specified test references. During the rent period, customers can use the opportunity to test the device to get desired result accompanied by Telkom Test House Engineer. For Wireless / Anechoic Chamber rent services, please pay attention to the following points :',
	'description_rent_chamber_1' => 'The chamber according to its specifications can be used for simulation and testing of RF/microwave, Antenna, and EMC Testing in the DC - 18 GHz frequency range. However, the provided Spectrum Analyzer facility is capable of reaching up to 40 GHz. The recommended maximum device/EUT (Equipment under test) dimension is 1mx1mx1m. Configuration testing is carried out at a maximum distance of 3m. There is only one customer for each chamber rent period.',
