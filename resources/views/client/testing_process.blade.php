					...
					<fieldset>
						...
						<div class="form-group">
							...
							<div id="attachment-file">
								...
								<a class="btn btn-link" style="margin-left:-10px; height:37px; color:black !important; font-size: 100%;" href="{{ url('/cetakPermohonan') }}" target="_blank" rel="noopener">{{ trans('translate.service_upload_click') }}</a>
							</div>
						</div>
						<div class="f1-buttons">
