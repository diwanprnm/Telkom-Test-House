                    ...
                    <table id="table_kuisioner" style="width:100%; padding: 2px;" border="1">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <input type="number" name="quest1_eks" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest1_perf" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                        <tr>
                          <td>2</td>
                          ...
                          <td>
                            <input type="number" name="quest2_eks" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest2_perf" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                        <tr>
                          <td>3</td>
                          ...
                          <td>
                            <input type="number" name="quest3_eks" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest3_perf" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                        <tr>
                          <td>4</td>
                         ...
                         <td>
                            <input type="number" name="quest4_eks" value="5" min="1" max="10" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest4_perf" value="5" min="1" max="10" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                        <tr>
                          <td>5</td>
                          ...
                          <td>
                            <input type="number" name="quest5_eks" value="5" min="1" max="10" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest5_perf" value="5" min="1" max="10" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                        <tr>
                          <td>6</td>
                          ...
                          <td>
                            <input type="number" name="quest6_eks" value="5" min="1" max="10" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest6_perf" value="5" min="1" max="10" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                        <tr>
                          <td>7</td>
                          ...
                          <td>
                            <input type="number" name="quest7_eks" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest7_perf" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                        <tr>
                          <td>8</td>
                          ...
                          <td>
                            <input type="number" name="quest8_eks" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest8_perf" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                        <tr>
                          <td>9</td>
                          ...
                          <td>
                            <input type="number" name="quest9_eks" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest9_perf" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                        <tr>
                          <td>10</td>
                          ...
                          <td>
                            <input type="number" name="quest10_eks" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest10_perf" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                        <tr>
                          <td>11</td>
                          ...
                          <td>
                            <input type="number" name="quest11_eks" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest11_perf" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                        <tr>
                          <td>12</td>
                          ...
                          <td>
                            <input type="number" name="quest12_eks" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest12_perf" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                        <tr>
                          <td>13</td>
                          ...
                          <td>
                            <input type="number" name="quest13_eks" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest13_perf" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                        <tr>
                          <td>14</td>
                          ...
                          <td>
                            <input type="number" name="quest14_eks" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest14_perf" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                        <tr>
                          <td>15</td>
                          ...
                          <td>
                            <input type="number" name="quest15_eks" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest15_perf" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                        <tr>
                          <td>16</td>
                          ...
                          <td>
                            <input type="number" name="quest16_eks" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest16_perf" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                        <tr>
                          <td>17</td>
                          ...
                          <td>
                            <input type="number" name="quest17_eks" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest17_perf" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                        <tr>
                          <td>18</td>
                          ...
                          <td>
                            <input type="number" name="quest18_eks" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest18_perf" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                        <tr>
                          <td>19</td>
                          ...
                          <td>
                            <input type="number" name="quest19_eks" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                          <td>
                            <input type="number" name="quest19_perf" min="1" max="10" value="5" placeholder="1-10" class="form-control">
                          </td>
                        </tr>
                      </tbody>
                    </table>
