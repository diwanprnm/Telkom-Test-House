				        ...
				        <div id="wizard">
					            ...
					            <fieldset>
					               <div class="form-group mui-radio">
										...
										<div class="form-group mui-textfield" style="margin-top:-30px; margin-bottom:30px; height:25px; font-size: 80%;">
					            ...
					            <fieldset>
					                <div class="form-group mui-textfield">
										...
										<div class="form-group mui-select">
											...
											<input type="hidden" name="f1-tgl-siupp" placeholder="{{ trans('translate.service_upload_siupp_date') }}" class="data-upload-berkas f1-tgl-siupp input-submit" id="f1-tgl-siupp" readonly>
										...
										<div class="form-group mui-select">
											...
											<input type="hidden" name="f1-batas-waktu" placeholder="{{ trans('translate.service_upload_certificate_date') }}" class="data-upload-berkas f1-batas-waktu input-submit" id="f1-batas-waktu" readonly>
											<div class="col-xs-1 selectContainer">
										...
										<div class="dv-srt-sp3">
											<div class="form-group col-xs-12 mui-textfield">
