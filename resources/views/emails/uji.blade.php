...
<div class="content" style="width:75%;min-height:450px;background-color:rgba(255,255,255,1.00);border: 3px #ff3e41 solid;border-radius:15px;position:relative;margin-left:auto;margin-right:auto;padding-left:25px;padding-right:25px;padding-top:5px;padding-bottom:5px;">
	...
	<p style="font-family:Helvetica; font-size:0.98em; color:rgba(146,146,146,1.00); margin-top:-7px;">
		Perangkat saudara/i saat ini sedang dalam proses uji (<strong style="font-style:italic;">on-progress</strong>) di Lab IAS DDS Telkom.
		<br><br>
		Salam hangat,
		<br>
