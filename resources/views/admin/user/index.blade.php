		...
		<div class="container-fluid container-fullw bg-white">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<select id="role" name="role" class="cs-select cs-skin-elastic" required>
											@if($filterRole == '')
												<option value="" disabled selected>Select...</option>
											@endif
											@if ($filterRole == 'all')
			...
			<div class="row">
				<div class="col-md-6 pull-right" style="margin-bottom:10px">
		            <a style=" color:white !important;" href="{{URL::to('/admin/user/create')}}">
							...
							<tbody>
								...
								@foreach($data as $item)
									<tr>
	                                    ...
	                                    <td class="center">
											<div>
												<a href="{{URL::to('admin/user/'.$item->id.'/edit')}}" class="btn btn-transparent btn-xs" tooltip-placement="top" tooltip="Edit"><em class="fa fa-pencil"></em></a>
												{!! Form::open(array('url' => 'admin/user/'.$item->id.'/softDelete')) !!}
													{!! csrf_field() !!}
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="dataTables_paginate paging_bootstrap_full_number pull-right" >
								<?php echo $data->appends(array('search' => $search,'company' => $filterCompany,'role' => $filterRole,'is_active' => $status))->links(); ?>
							</div>
						</div>
					</div>
				</div>
	...
	jQuery(document).ready(function() {       
		$('#search_value').keydown(function(event) {
	        if (event.keyCode == 13) {
				...
				document.location.href = baseUrl+'/admin/user?'+jQuery.param(params);
	        }
	    });
