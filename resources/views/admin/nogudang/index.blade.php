...
<div class="main-content" >
	<div class="wrap-content container" id="container">
		...
		<section id="page-title">
			<div class="row">
				<div class="col-sm-8">
					<h1 class="mainTitle">Nomor Gudang</h1>
				</div>
				<ol class="breadcrumb">
					<li>
						<span>Pengujian</span>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-control" id="nogudang" name="nogudang" class="chosen-nogudang">
												@if ($filterNoGudang == '')
													<option value="" disabled selected> - Pilih Nomor Gudang - </option>
												@endif
												@if ($filterNoGudang == 'all')
													<option value="all" selected>All</option>
												@else
													<option value="all">All</option>
												@endif
											@foreach($nogudang as $item)
												@if($item->no == $filterNoGudang)
													<option value="{{ $item->no }}" selected>{{ $item->no }}</option>
												@else
...
<script type="text/javascript">
	...
	$('#nogudang').chosen();
	$('#nogudang').trigger("chosen:updated");
	$('#company').chosen();
...
/*end sorting*/
				...
				document.location.href = baseUrl+'/admin/nogudang?'+jQuery.param(params);
	        }
	    });
	    ...
	    document.getElementById("filter").onclick = function() {
			...
			var nogudang = document.getElementById("nogudang");
			var nogudangValue = nogudang.options[nogudang.selectedIndex].value;
...
/*end sorting*/			
			document.location.href = baseUrl+'/nogudang/excel?'+jQuery.param(params);
	    };
	});
</script>
@endsection