...
<div class="main-content" >
	<div class="wrap-content container" id="container">
		...
		<section id="page-title">
			<div class="row">
				<div class="col-sm-8">
					<h1 class="mainTitle">Lab Pengujian</h1>
				</div>
				<ol class="breadcrumb">
					<li>
						<span>Beranda</span>
		...
		<div class="container-fluid container-fullw bg-white">
	        <div class="row">
		        <div class="col-md-6">
					<a style=" color:white !important;" href="{{URL::to('/admin/labs/create')}}">
						<button type="button" class="btn btn-wide btn-green btn-squared" >
						Tambah Lab Pengujian
						</button>         
					</a>
		        </div>
				<div class="col-md-6">
							...
							<tbody>
								...
								@foreach($data as $item)
									<tr>
										...
										<td class="center">{{ $item->lab_code }}</td>
	                                    ...
	                                    <td class="center">
											<div>
												<a href="{{URL::to('admin/labs/'.$item->id.'/edit')}}" class="btn btn-transparent btn-xs" tooltip-placement="top" tooltip="Edit"><em class="fa fa-pencil"></em></a>
												{!! Form::open(array('url' => 'admin/labs/'.$item->id, 'method' => 'DELETE')) !!}
													{!! csrf_field() !!}
	...
	$( function() {
		$( "#search_value" ).autocomplete({
			...
			source: function (request, response) {
				$.ajax({
					type: 'GET',
					url: 'adm_labs_autocomplete/'+request.term,
					dataType: "json",
					cache: false,
	...
	jQuery(document).ready(function() {       
		$('#search_value').keydown(function(event) {
	        if (event.keyCode == 13) {
				...
				document.location.href = baseUrl+'/admin/labs?'+jQuery.param(params);
	        }
	    });
	});
</script>>
