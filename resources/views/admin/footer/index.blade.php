...
<div class="main-content" >
	<div class="wrap-content container" id="container">
		...
		<div class="container-fluid container-fullw bg-white">
	        <div class="row">
		        <div class="col-md-6">
		            <a style=" color:white !important;" href="{{URL::to('/admin/footer/create')}}">
						<button type="button" class="btn btn-wide btn-green btn-squared" >
							Tambah Informasi di Footer
						</button>         
					</a>
		        </div>
				<div class="col-md-6">
							...
							<tbody>
								...
								@foreach($data as $item)
									<tr>
										...
										<td class="center"><img src="{{asset('media/footer/'.$item->image)}}" width="240"/></td>
	                                    ...
	                                    <td class="center">
											<div>
												<a href="{{URL::to('admin/footer/'.$item->id.'/edit')}}" class="btn btn-transparent btn-xs" tooltip-placement="top" tooltip="Edit"><i class="fa fa-pencil"></i></a>
												{!! Form::open(array('url' => 'admin/footer/'.$item->id, 'method' => 'DELETE')) !!}
													{!! csrf_field() !!}
	...
	$( function() {
		$( "#search_value" ).autocomplete({
			...
			source: function (request, response) {
				$.ajax({
					type: 'GET',
					url: 'adm_footer_autocomplete/'+request.term,
					dataType: "json",
					cache: false,
	...
	jQuery(document).ready(function() {       
		$('#search_value').keydown(function(event) {
	        if (event.keyCode == 13) {
				...
				document.location.href = baseUrl+'/admin/footer?'+jQuery.param(params);
	        }
	    });
	});
</script>
