...
<div class="main-content" >
	<div class="wrap-content container" id="container">
		...
		<section id="page-title">
			<div class="row">
				<div class="col-sm-8">
					<h1 class="mainTitle">Tarif Kalibrasi</h1>
				</div>
				<ol class="breadcrumb">
					<li>
						<span>Beranda</span>
		...
		<div class="container-fluid container-fullw bg-white">
			...
			<div class="row">
				<div class="col-md-6 pull-right" style="margin-bottom:10px">
					<a style=" color:white !important;" href="{{URL::to('/admin/calibration/create')}}">
						<button type="button" class="btn btn-wide btn-green btn-squared pull-right" >Tambah Tarif Kalibrasi</button>
					</a>
		        </div>
				<div class="col-md-12">
							...
							<tbody>
								...
								@foreach($data as $item)
									<tr>
	                                    ...
	                                    <td class="center">
											<div>
												<a href="{{URL::to('admin/calibration/'.$item->id.'/edit')}}" class="btn btn-transparent btn-xs" tooltip-placement="top" tooltip="Edit"><em class="fa fa-pencil"></em></a>
												{!! Form::open(array('url' => 'admin/calibration/'.$item->id, 'method' => 'DELETE')) !!}
													{!! csrf_field() !!}
	...
	$( function() {
		$( "#search_value" ).autocomplete({
			...
			source: function (request, response) {
				$.ajax({
					type: 'GET',
					url: 'adm_calibration_autocomplete/'+request.term,
					dataType: "json",
					cache: false,
