...
<div class="main-content" >
	<div class="wrap-content container" id="container">
		...
		<section id="page-title">
			<div class="row">
				<div class="col-sm-8">
					<h1 class="mainTitle">Pengujian Batal</h1>
				</div>
				<ol class="breadcrumb">
					<li>
						<span>Pengujian</span>
		...
		<div class="container-fluid container-fullw bg-white">
			<div class="row">
				<div class="col-md-6">
	    			...
	    			<!-- <a class="btn btn-info pull-left" href="{{URL::to('examinationcancel/excel')}}"> Export to Excel</a> -->
				</div>
				<div class="col-md-6">
										...
										<div id="step-1">
											<div class="form-group">
												<table class="table table-condensed"><caption></caption>
													<thead>
														<tr>
															<th colspan="3" class="left" scope="col"><p style="color:red">Perangkat ini dibatalkan oleh kastamer dengan alasan {{ $item->reason_cancel }}</p></th>
														</tr>
														<tr>
					                        ...
					                        <div class=" pull-right">
					                        	<a class="btn btn-wide btn-primary btn-margin" href="{{URL::to('admin/examinationcancel/'.$item->id.'/edit')}}">Lihat</a>
					                        	<a class="btn btn-wide btn-primary pull-right" style="margin-left:10px" href="{{URL::to('admin/examinationcancel/'.$item->id)}}">Detail</a>
					                        </div>
										</div>
									</div>
	  							</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="dataTables_paginate paging_bootstrap_full_number pull-right" >
								@php echo $data->appends(array('search' => $search,'type' => $filterType))->links(); @endphp
							</div>
						</div>
					</div>
				</div>
