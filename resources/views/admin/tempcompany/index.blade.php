								...
								@foreach($data as $item)
									<tr>
										...
										<td class="center">
											...
											@if($item->siup_number != NULL)No. SIUP, @endif($item->siup_number != NULL)
											@if($item->siup_file != NULL)File SIUP, @endif($item->siup_file != NULL)
											@if($item->siup_date != NULL)Masa berlaku SIUP, @endif($item->siup_date != NULL)
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="dataTables_paginate paging_bootstrap_full_number pull-right" >
								@php echo $data->appends(array('search' => $search,'is_commited' => $status,'before_date' => $before_date,'after_date' => $after_date,'sort_by' => $sort_by,'sort_type' => $sort_type))->links(); @endphp
							</div>
						</div>
					</div>
				</div>
