...
<div class="main-content" >
	<div class="wrap-content container" id="container">
		...
		<section id="page-title">
			<div class="row">
				<div class="col-sm-8">
					<h1 class="mainTitle">Edit Slideshow</h1>
				</div>
				<ol class="breadcrumb">
					<li>
						<span>Beranda</span>
		...
		<div class="container-fluid container-fullw bg-white">
			<div class="col-md-12">
				{!! Form::open(array('url' => 'admin/slideshow/'.$data->id, 'method' => 'PUT', 'enctype' => 'multipart/form-data')) !!}
					{!! csrf_field() !!}
    				<fieldset>
						<legend>
							Edit Slideshow
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="text" name="headline" class="form-control" placeholder="Headline" value="{{ $data->headline }}" required>
								</div>
							</div>
	                        <div class="col-md-12">
								<div class="form-group">
