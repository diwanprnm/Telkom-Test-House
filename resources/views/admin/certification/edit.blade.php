...
<div class="main-content" >
	<div class="wrap-content container" id="container">
		...
		<section id="page-title">
			<div class="row">
				<div class="col-sm-8">
					<h1 class="mainTitle">Edit Certification</h1>
				</div>
				<ol class="breadcrumb">
					<li>
						<span>Beranda</span>
		...
		<div class="container-fluid container-fullw bg-white">
			<div class="col-md-12">
				{!! Form::open(array('url' => 'admin/certification/'.$data->id, 'method' => 'PUT', 'enctype' => 'multipart/form-data')) !!}
					{!! csrf_field() !!}
    				<fieldset>
						<legend>
							Edit Certification
						...
						<div class="row">
	                        ...
	                        <div class="col-md-12">
								<div class="form-group">
									...
									<img src="{{asset('media/certification/'.$data->image)}}" width="240px">
