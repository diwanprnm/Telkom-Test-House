...
<div class="main-content" >
	<div class="wrap-content container" id="container">
		...
		<section id="page-title">
			<div class="row">
				<div class="col-sm-8">
					<h1 class="mainTitle">Certification</h1>
				</div>
				<ol class="breadcrumb">
					<li>
						<span>Beranda</span>
		...
		<div class="container-fluid container-fullw bg-white">
	        <div class="row">
		        <div class="col-md-6">
		                <a style=" color:white !important;" href="{{URL::to('/admin/certification/create')}}">
							...
							<tbody>
								...
								@foreach($data as $item)
									<tr>
	                                    ...
	                                    <td class="center">
											<div>
												<a href="{{ URL::to('admin/certification/'.$item->id.'/edit')}}" class="btn btn-transparent btn-xs" tooltip-placement="top" tooltip="Edit"><em class="fa fa-pencil"></em></a>
	...
	$( function() {
		$( "#search_value" ).autocomplete({
			...
			source: function (request, response) {
				$.ajax({
					type: 'GET',
					url: 'adm_certification_autocomplete/'+request.term,
					dataType: "json",
					cache: false,
	...
	jQuery(document).ready(function() {       
		$('#search_value').keydown(function(event) {
	        if (event.keyCode == 13) {
				...
				document.location.href = baseUrl+'/admin/certification?'+jQuery.param(params);
	        }
	    });
	});
</script>>
