...
<body>
    ...
    <div id="notfound">
        <div class="notfound">
            ...
            <p>Unautorizhed. <br>{{ trans('translate.qs_certifcate_date_expired_message1') }}.<br>{{ trans('translate.qs_certifcate_date_expired_message2') }}<br><a href="{{URL::to('/process')}}">{{ trans('translate.back') }}</a></p>
        </div>
    </div>
