    ...
    public function run()
    {
        DB::table('email_editors')->insert([
            [
                ...
                'id' => '14', 
                'name' => 'Step Sidang QA (Fail)', 
                'subject' => 'Pemberitahuan Hasil Pengujian Perangkat [@device_name | @device_mark | @device_model | @device_capacity]', 
                'dir_name' => 'emails.qaFail', 
                'logo' => 'Telkom Test House.png',
                'content' => '<p><i>Kepada Yth.&nbsp;</i><br><i>Bapak/Ibu @user_name&nbsp;</i><br><br>&nbsp;</p><p>Kami Laboratorium Telkom Test House memberitahukan kepada @company_name bahwa pengujian perangkat:<br>Nama Perangkat: @device_name&nbsp;<br>Merek: @device_mark<br>Jenis/Tipe: @device_model<br>Kapasitas: @device_capacity</p><p>Telah&nbsp;menyelesaikan serangkaian proses uji menggunakan referensi @test_reference, dan kami menyatakan bahwa perangkat tersebut <strong>TIDAK LULUS</strong>.</p><p>Anda bisa mengunduh Laporan Hasil Uji (LHU) di <a href="www.telkomtesthouse.co.id">www.telkomtesthouse.co.id</a> dengan cara masuk/login terlebih dahulu, lalu pilih menu pengujian/testing &gt; status pengujian/progress dan tekan tombol unduh laporan/download report yang terletak di kanan bawah dari permohonan uji.<br>&nbsp;<br>Terimakasih atas kerjasama anda.&nbsp;<br>Untuk info lebih lanjut silakan hubungi kami di <strong>+62 812 2483 7500</strong></p>',
                'signature' => '<p>Salam hangat,&nbsp;<br>Telkom Test House, PT. Telekomunikasi Indonesia, Tbk.&nbsp;<br><br>---&nbsp;<br><br>&nbsp;</p><p>&nbsp;</p><p><i>Email ini dihasilkan secara otomatis oleh sistem dan mohon untuk tidak membalas email ini. Informasi lebih lanjut hubungi User Relation di <strong>0812 2483 7500</strong> (Telepon &amp; WA) atau <strong>cstth@telkom.co.id</strong></i></p>',
                'created_by' => '1',
                'updated_by' => '1',
                'created_at' => date("Y-m-d H:i:s"),
                ...
                'logo' => 'Telkom Test House.png',
                'content' => '<p><i>Kepada Yth.&nbsp;</i><br><i>Bapak/Ibu @user_name&nbsp;</i><br><br>&nbsp;</p><p>Berikut kode OTP anda: <strong>@token_verification</strong>.&nbsp;<br>Silahkan masukkan kode OTP tersebut untuk verifikasi akun anda.</p>',
                'signature' => '<p>Salam hangat,&nbsp;<br>Telkom Test House, PT. Telekomunikasi Indonesia, Tbk.&nbsp;<br><br>---&nbsp;<br><br>&nbsp;</p><p>&nbsp;</p><p><i>Email ini dihasilkan secara otomatis oleh sistem dan mohon untuk tidak membalas email ini. Informasi lebih lanjut hubungi User Relation di <strong>0812 2483 7500</strong> (Telepon &amp; WA) atau <strong>cstth@telkom.co.id</strong></i></p>',
                'created_by' => '1',
                'updated_by' => '1',
                'created_at' => date("Y-m-d H:i:s"),
